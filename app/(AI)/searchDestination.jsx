...
const SearchDestination = () => {
            ...
            if (data.results && data.results.length > 0) {
                ...
                setTripData(prevData => ({
                    ...
                    tour_info: {
                        ...
                        google_maps_url: `https://maps.google.com/?q=${coordinate.latitude},${coordinate.longitude}`,
                    }
                }));
            }
        } catch (error) {
    ...
    const handlePlaceSelection = (data, details) => {
        ...
        // Use the details parameter directly, not the state variable - merge with existing data
        setTripData(prevData => ({
            ...prevData,
            tour_info: {
                destination_ID: data.place_id,
                            ...
                            {selectedPlace && (
                                <View style={styles.selectedLocationCard}>
                                    <Text style={styles.selectedLocationTitle}>
                                        <Ionicons name="location" size={16} color={theme.primary} /> Selected Destination
                                    </Text>
                            ...
                            {!selectedPlace && (
                                <View style={styles.instructionText}>
                                    <Text style={styles.instructionTitle}>
                                        <Ionicons name="map" size={16} color={theme.primary} /> How to select destination
                                    </Text>
                ...
                <View style={{ padding: 20, backgroundColor: theme.background }}>
                    ...
                    >
                        <Text
                            ...
                            ellipsizeMode="tail"
                        >
                            {placeDetails ? 'Next' : 'Select a destination on the map'}
                        </Text>
                        {placeDetails && (
